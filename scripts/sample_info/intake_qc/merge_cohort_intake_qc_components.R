...
parser$add_argument("--cov", metavar=".tsv", type="character", required=TRUE,
                    help="GATK-SV coverage mean & median")
...
# # DEV:
# args <- list("demo" = "/var/folders/zj/59lpkx5926376cnm6l48d2x00000gp/T//gtex_demo/gtex.demo.tsv.gz",
#              "charr" = "/var/folders/zj/59lpkx5926376cnm6l48d2x00000gp/T//gtex_charr/gtex.charr.tsv.gz",
#              "cov" = "/var/folders/zj/59lpkx5926376cnm6l48d2x00000gp/T//gtex_cov/gtex.cov.tsv.gz",
#              "ploidy" = "/var/folders/zj/59lpkx5926376cnm6l48d2x00000gp/T//gtex.ploidy.tsv.gz",
#              "out_tsv" = "~/scratch/gtex.intake_qc.test.tsv")
...
out.col.order <- c("Sample", "Cohort", "grafpop_SNPs", "grafpop_GD1", "grafpop_GD2",
                   ...
                   "INCONSISTENT_AB_HET_RATE", "rd_median", "rd_mean", "chr1_CopyNumber",
                   "chr2_CopyNumber", "chr3_CopyNumber", "chr4_CopyNumber", "chr5_CopyNumber",
                   "chr6_CopyNumber", "chr7_CopyNumber", "chr8_CopyNumber", "chr9_CopyNumber",
                   "chr10_CopyNumber", "chr11_CopyNumber", "chr12_CopyNumber",
                   "chr13_CopyNumber", "chr14_CopyNumber", "chr15_CopyNumber",
                   "chr16_CopyNumber", "chr17_CopyNumber", "chr18_CopyNumber",
                   "chr19_CopyNumber", "chr20_CopyNumber", "chr21_CopyNumber",
                   "chr22_CopyNumber", "chrX_CopyNumber", "chrY_CopyNumber",
                   "median_coverage", "wgd_score", "nondiploid_bins")
